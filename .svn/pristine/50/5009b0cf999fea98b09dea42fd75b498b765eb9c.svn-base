...
import { UI_ShareResultMediator } from "../UIExt/DefaultUI/UI_ShareResultMediator";
import View_HotGames from "../UIExt/DefaultUI/Cmp/View_HotGames";
...
export default class TTPlatform extends WXPlatform {
    ...
    Init(platformData: LTPlatformData) {
        ...
        this.recordManager = new TTRecordManager(this.base);
        this.device = new TTDevice(this.base);
                    ...
                    this.base.getUserInfo(
                        {
                            ...
                            success: (res) => {
                                ...
                                CommonSaveData.instance.avatarUrl = res.userInfo.avatarUrl;
                                CommonSaveData.instance.nickName = res.userInfo.nickName;
    ...
    */
                ...
                success: (rst) => {
                    ...
                    if (rst.videoId) {
                        ...
                        if (window["__GM"]) {
                            ...
                            UI_ShareResultMediator.instance.Show(rst.videoId);
                        }
                    }
                },
                fail: (e) => {
    ...
    showGameBoxBannerAd() {
        if (this.systemInfo.appName == EHostApp.Douyin && window["tt"].showGridGamePanel && LTSDK.instance.configs.isNavEnable) {
