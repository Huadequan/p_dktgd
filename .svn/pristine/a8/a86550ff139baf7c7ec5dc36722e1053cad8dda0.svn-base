...
export default class LTG_UI_SetMediator extends BaseUIMediator<LTG_UI_Set> {
    ...
    _OnShow() {
        ...
        this.ui.m_view.m_btn_statement.onClick(this, this._OnClickStatement);
        this.ui.m_view.m_btn_statement.visible = LTPlatform.instance.platform == EPlatformType.Web || LTPlatform.instance.platform == EPlatformType.Oppo;
