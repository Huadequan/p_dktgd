...
import LTG_UI_state_txt from "./LTG_UI_state_txt";
...
export default class LTComBinder{
	public static bindAll():void {
		...
		fgui.UIObjectFactory.setExtension(LTG_UI_item_rank.URL, LTG_UI_item_rank);
		...
		fgui.UIObjectFactory.setExtension(LTG_UI_normal_btn_ad.URL, LTG_UI_normal_btn_ad);
		fgui.UIObjectFactory.setExtension(LTG_UI_Statement.URL, LTG_UI_Statement);
		fgui.UIObjectFactory.setExtension(LTG_UI_state_txt.URL, LTG_UI_state_txt);
