...
public class MainActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * sdk初始化API
         * 【注意】，除初始化API，其他API，需要在SDK初始化完成回调后，才能调用。
         */
        VGameCore.init(this, new LGSdkInitCallback() {
            @Override
            public void onInitSuccess(String deviceID, String installID, String ssID, String uuID) {
                Log.e("1","sdk初始化完成");
                Log.e("test", "sdk init success, deviceID = " + deviceID + " installID = " + installID
                        + " ssID = " + ssID + " uuID = " + uuID);
                ADManager.getInstance().PreloadRewardAD();
            }

            @Override
            public void onInitFailed(int code, String msg) {
                //  DemoTips.getInstance().show("sdk初始化失败 code = " + code + " msg = " + msg);
                Log.e("test", "sdk init failed code = " + code + " msg: " + msg);
            }
        });
