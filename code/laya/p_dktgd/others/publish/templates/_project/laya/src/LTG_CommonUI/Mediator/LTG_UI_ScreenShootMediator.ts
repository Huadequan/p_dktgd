...
export default class LTG_UI_ScreenShootMediator extends BaseUIMediator<LTG_UI_ScreenShoot> {
    ...
    _OnShow() {
        ...
        if (this._cacheData.reward_icon) {
            this.ui.m_view.m_reward_icon.url = this._cacheData.reward_icon;
        } else {
            this.ui.m_view.m_reward_icon.url = GameConst.data.share_reward_icon;
        }
